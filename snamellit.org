...
#+BEGIN_SRC emacs-lisp
  ...
  ;; when a list of paths is given, then each path should
  ;; point to a virtualenv. All of them must have a unique
  ;; folder name (the last part of the path) as that is used
  ;; to find the right virtualenv to activate
  ;;(setq venv-location  '("/Users/pti/Nitrous/snamellit-6031/python-100545/itbiusers"
