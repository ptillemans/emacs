(custom-set-variables
 ...
 '(org-structure-template-alist (quote (("S" "#+BEGIN_SRC emacs-lisp
?
#+END_SRC" "<src lang=\"?\">
...
#+END_ASCII" "") ("A" "#+ASCII: " "") ("i" "#+INDEX: ?" "#+INDEX: ?") ("I" "#+INCLUDE: %file ?" "<include file=%file markup=\"?\">"))))
 '(rcirc-server-alist (quote (("irc.freenode.net" :channels ("#emacs" "#rcirc" "#clojure" "#cucumber" "#leiningen" "#ubuntu-bugs")) ("irc.geekshed.net" \#jupiterbroadcasting nil))) t)
